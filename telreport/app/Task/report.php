...
<form class="form">
	...
	<div class="flex fix">
		...
		<?=Inp('finish_time','|實際完成 <span class="setNow">NOW</span>','<input type="text" class="datetime" value="'.getTime(time(),'html').'"/>',false)?>
	</div>
	<style>
...
<script>
var disarr="priority|title|project_id|resp_id|start_time|deadline_time".split('|').join(',#');
